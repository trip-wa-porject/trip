...
class _DropdownMenuPainterDatePicker extends CustomPainter {
  _DropdownMenuPainterDatePicker({
    this.color,
    this.elevation,
    this.selectedIndex,
...
class _DropdownMenuState<T> extends State<_DropdownMenu<T>> {
  ...
  DropdownMenuType get dropdownMenuType => widget.route.dropdownMenuType;
  ...
  Widget build(BuildContext context) {
    ...
    return FadeTransition(
      ...
      child: CustomPaint(
        painter: dropdownMenuType == DropdownMenuType.datePicker
            ? _DropdownMenuPainterDatePicker(
...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  ...
  final DropdownMenuType dropdownMenuType;
...
class CustomizedDropdownButton<T> extends StatefulWidget {
  /// Creates a CustomizedDropdownButton
  ...
  CustomizedDropdownButton({
    ...
    this.barrierColor,
    this.barrierLabel,
    this.dropdownMenuType = DropdownMenuType.normal,
  ...
  CustomizedDropdownButton._formField({
    super.key,
    required this.items,
    this.selectedItemBuilder,
    this.value,
  ...
  ///
  /// If the [onChanged] callback is null or the list of [CustomizedDropdownButton.items]
  /// is null then the dropdown button will be disabled, i.e. its arrow will be
  /// displayed in grey and it will not respond to input. A disabled button
  /// will display the [CustomizedDropdownButton.disabledHint] widget if it is non-null.
  /// If [CustomizedDropdownButton.disabledHint] is also null but [CustomizedDropdownButton.hint] is
  /// non-null, [CustomizedDropdownButton.hint] will instead be displayed.
  /// {@endtemplate}
  ...
  @override
  State<CustomizedDropdownButton<T>> createState() =>
      CustomizedDropdownButtonState<T>();
}

class CustomizedDropdownButtonState<T>
    extends State<CustomizedDropdownButton<T>> with WidgetsBindingObserver {
  int? _selectedIndex;
  ...
  @override
  void didUpdateWidget(CustomizedDropdownButton<T> oldWidget) {
  ...
  // Also, CustomizedDropdownButton should be public as we need typed access to it through key.
  ...
  bool get _enabled =>
      (widget.dropdownMenuType == DropdownMenuType.datePicker &&
...
/// A [FormField] that contains a [CustomizedDropdownButton].
///
/// This is a convenience widget that wraps a [CustomizedDropdownButton] widget in a
/// [FormField].
///
...
/// See also:
///
///  * [CustomizedDropdownButton], which is the underlying text field without the [Form]
///    integration.
class DropdownButtonFormField2<T> extends FormField<T> {
  /// Creates a [CustomizedDropdownButton] widget that is a [FormField], wrapped in an
  /// [InputDecorator].
  ///
                ...
                builder: (BuildContext context, StateSetter setState) {
                  return InputDecorator(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: CustomizedDropdownButton._formField(
  ...
  /// The key of CustomizedDropdownButton child widget
  ///
  /// This allows accessing CustomizedDropdownButtonState.
